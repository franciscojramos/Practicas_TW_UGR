...
Abre en el navegador: **http://localhost:8080/** (por ejemplo `index.php`, `sobremi.php`, `contacto.php`).
...
El código de la aplicación está en **`src/`**. El directorio **`data/`** guarda los datos de **MariaDB** y no debe versionarse (está en `.gitignore`).
...
Este repositorio es material académico para la práctica de la asignatura; las credenciales de ejemplo en Docker son solo para desarrollo local.
